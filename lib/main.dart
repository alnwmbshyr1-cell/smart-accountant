...
class LivestockDb {
  ...
  Future<int> addHealthRecord(String animal, String condition, String notes, String status) async => _db!.insert('health_records', {'animal_number': animal, 'condition': condition, 'notes': notes, 'status': status, 'date': DateTime.now().toIso8601String()});
