...
- [ ] تحديث عميل Flutter لتوفير access token وتجديده والتراجع عند انقطاع الشبكة
- [ ] اختبار 401 و403 وانتهاء التوكن ورفض الجمهور والصلاحيات
- [ ] اختبار حفظ SQLite المحلي وعدم التكرار عند فشل Backend وإعادة المحاولة
